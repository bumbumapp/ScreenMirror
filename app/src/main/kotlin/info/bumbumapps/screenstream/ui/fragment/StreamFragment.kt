...
import info.bumbumapps.screenstream.data.model.FatalError
import info.bumbumapps.screenstream.data.model.FixableError
import info.bumbumapps.screenstream.data.model.HttpClient
import info.bumbumapps.screenstream.data.other.asString
import info.bumbumapps.screenstream.data.other.bytesToMbit
import info.bumbumapps.screenstream.data.other.getLog
import info.bumbumapps.screenstream.data.other.getQRBitmap
import info.bumbumapps.screenstream.data.other.setColorSpan
import info.bumbumapps.screenstream.data.other.setUnderlineSpan
import info.bumbumapps.screenstream.data.settings.SettingsReadOnly
import info.bumbumapps.screenstream.databinding.FragmentStreamBinding
import info.bumbumapps.screenstream.databinding.ItemClientBinding
import info.bumbumapps.screenstream.databinding.ItemDeviceAddressBinding
...
import info.bumbumapps.screenstream.ui.activity.ServiceActivity
